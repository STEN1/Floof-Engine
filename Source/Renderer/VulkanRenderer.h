...
namespace FLOOF {
    ...
    public:
        ...
        VkDescriptorSet AllocatePBRMapsDescriptorSet(VkDescriptorSetLayout descriptorSetLayout);
        ...
        void FreePBRMapsDescriptorSet(VkDescriptorSet desctriptorSet);
    ...
    private:
        ...
        VkDescriptorPool m_PBRMatDescriptorPool;
